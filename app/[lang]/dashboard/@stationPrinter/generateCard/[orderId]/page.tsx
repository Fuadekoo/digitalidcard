...
import { getCardData } from "@/actions/stationPrintral/citizenCard";
...
export default function GenerateCardPage({ params }: PageProps) {
  ...
  const [cardData, isLoading, refresh] = useData(
    getCardData,
    () => {},
    orderId
  );
    ...
    >
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-4">
          <Link
            href={`/${resolvedParams.lang}/dashboard/@stationPrinter/citizenCard`}
          >
