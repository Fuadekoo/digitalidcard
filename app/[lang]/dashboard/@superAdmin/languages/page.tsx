...
export default function LanguagesPage() {
  ...
  const handleAddTranslationKey = () => {
    ...
    addNewTranslationKey(newKeyForm.key, newKeyForm.translations);
  ...
  const handleSaveEditedTranslation = () => {
    ...
    Object.entries(editingTranslation).forEach(([langCode, value]) => {
      updateTranslation(selectedTranslationKey.key, langCode, value);
    });
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          ...
          <Button variant="outline" onClick={() => setIsAddKeyDialogOpen(true)}>
            <Plus className="h-4 w-4 mr-2" />
            Add Translation Key
          </Button>
          {hasUnsavedChanges && (
            <Button onClick={handleSaveTranslations} disabled={isLoading}>
              {isLoading ? (
