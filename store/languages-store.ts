...
async function loadTranslationsFromJSON(langCode: string) {
  try {
    ...
    if (!res.ok) throw new Error(`Failed to load ${langCode} translations`);
...
const initialTranslations: TranslationKey[] = [
  ...
  },
  {
    ...
    translations: {
      ...
      sm: "Saxiixa Isticmaalaha wuu fashilmay",
    },
  },
  {
    ...
    translations: {
      ...
      sm: "Goobta Email ama Taleefanka waa qasab",
    },
  },
  {
